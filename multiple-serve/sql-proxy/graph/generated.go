...
type EntityResolver interface {
	...
	FindEquipmentPropertyByID(ctx context.Context, id string) (*model.EquipmentProperty, error)
}
...
union _Entity = Equipment | EquipmentProperty
...
func (ec *executionContext) __Entity(ctx context.Context, sel ast.SelectionSet, obj fedruntime.Entity) graphql.Marshaler {
	...
	case *model.Equipment:
		...
		return ec._Equipment(ctx, sel, obj)
	case model.EquipmentProperty:
		return ec._EquipmentProperty(ctx, sel, &obj)
	case *model.EquipmentProperty:
		if obj == nil {
			return graphql.Null
		}
...
var equipmentImplementors = []string{"Equipment", "_Entity"}
...
var equipmentPropertyImplementors = []string{"EquipmentProperty", "_Entity"}
