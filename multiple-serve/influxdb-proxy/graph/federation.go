...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "EquipmentProperty":
			resolverName, err := entityResolverNameForEquipmentProperty(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "EquipmentProperty": %w`, err)
			}
			switch resolverName {
			...
			case "findEquipmentPropertyByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findEquipmentPropertyByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindEquipmentPropertyByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "EquipmentProperty": %w`, err)
				}
...
func entityResolverNameForEquipmentProperty(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
