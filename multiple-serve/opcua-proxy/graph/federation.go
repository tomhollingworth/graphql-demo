...
func (ec *executionContext) resolveEntity(
	...
	case "EquipmentProperty":
		...
		if err != nil {
			return nil, fmt.Errorf(`finding resolver for Entity "EquipmentProperty": %w`, err)
		}
		switch resolverName {
...
func entityResolverNameForEquipmentProperty(ctx context.Context, rep EntityRepresentation) (string, error) {
	for {
		var (
